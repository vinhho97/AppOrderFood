package com.example.huynhvinh.projectorderfood.Database;
...
public class CreateDatabase extends SQLiteOpenHelper {
    ...
    public static String TB_MONAN_TENMONAN = "TENMON";
    ...
    public SQLiteDatabase open(){
        return this.getWritableDatabase();      // this ở đây là SQLite Database
    }
}